...
namespace Elin_ArsMoriendi
{
        ...
        where TTrigger : notnull
    {
        ...
        /// <summary>
        /// Branching rule constructor.
        /// Keeps (state, trigger) unique while allowing multiple forward targets.
        /// </summary>
        public QuestTriggeredTransitionRule(
            TState from,
            TTrigger trigger,
    ...
    /// <summary>
    /// Generic state machine that evaluates transitions by (current state, trigger).
    /// This machine assumes strictly forward-only progression (to > from).
    /// Use branching rules to branch forward, and additional from-states to converge.
    /// </summary>
