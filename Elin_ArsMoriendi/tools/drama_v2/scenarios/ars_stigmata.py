    ...
    d.node(
        ...
        *d.seq(
            d.line(
                ...
                actor=narrator,
                en="-- Between the pages, a fragment in a different hand was tucked away.\nKaren's writing. An unsent letter addressed to Erenos.",
                cn="……禁书的书页间夹着一段不同笔迹的文字。\n是卡伦的字。写给艾雷诺斯的、未曾送达的信。",
            ),
            d.wait(0.3),
            d.line(
                "アルヴィンは笑っていた。\n自分が何を失ったか\n理解していない……\n\nあるいは理解した上で、\nそれを損失と\n思わなくなっていた。",
                actor=ars_karen,
                en="Alvin was smiling.\nHe did not understand\nwhat he had lost...\n\nOr perhaps he understood,\nand no longer considered\nit a loss.",
                cn="阿尔文在笑。\n他不理解\n自己失去了什么……\n\n又或者他理解了，\n却不再认为\n那是一种损失。",
            ),
            d.line(
                "どちらが正しいのか\n確かめる術は、\nもう私にはない。",
                actor=ars_karen,
                en="I no longer have the means\nto determine\nwhich is true.",
                cn="哪一种才是真相，\n我已无从\n判断。",
            ),
            d.wait(0.5),
            d.go("confession"),
    ...
    d.node(
        ...
        *d.seq(
            d.line(
                ...
                actor=narrator,
                en="Now that you know of the first's apotheosis ritual, what should you do?\n...You asked yourself.",
                cn="如今已知晓初代的升华仪式，我该怎么做？\n……你自问自答。",
            ),
            d.choice_block(
                [
                    d.option(
                        "実践しよう。これで連鎖を止められるかもしれない",
                        "motive_react_0",
                        en="I will attempt it. Perhaps this can end the cycle",
                        cn="去实践吧。或许这能终结连锁",
                        text_id="st_ca",
                    ),
                    d.option(
                        "力が手に入る。ならば、やってみる価値がある",
                        "motive_react_1",
                        en="Power awaits. Then it is worth the attempt",
                        cn="力量在前方。既如此，值得一试",
                        text_id="st_cb",
                    ),
                    d.option(
                        "やめたいとは思わない。...それが答えだ",
                        "motive_react_2",
                        en="I don't want to stop. That is my answer",
                        cn="不想停下。……这便是答案",
                        text_id="st_cc",
                    ),
                ]
