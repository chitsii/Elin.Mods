// <auto-generated>
// Generated by generate_quest_data.py at 2026-02-11T19:30:13.515773
// Do not edit manually. Edit tools/arena/data/quests.py instead.
// </auto-generated>
    ...
    public static class ArenaQuestDatabase
    {
        ...
        private static void Initialize()
        {
            ...
            var q_04_rank_up_F = new ArenaQuestDefinition
            {
                ...
                QuestType = ArenaQuestType.RankUp,
                DramaId = "rank_up_F",
                DisplayNameJP = "ランクF昇格試合（ヴォイド・アイスハウンド）",
                DisplayNameEN = "Rank F Promotion Trial (Void Ice Hound)",
                Description = "ヴォイド・アイスハウンドを倒し、ランクFを獲得する",
                Phase = StoryPhase.Initiation,
                QuestGiver = "sukutsu_arena_master",
                AutoTrigger = false,
                AdvancesPhase = StoryPhase.Rising,
                RequiredQuests = new List<string> { "02_rank_up_G", "03_zek_intro" },
                Priority = 900
            };
            ...
            var q_06_rank_up_E = new ArenaQuestDefinition
            {
                ...
                QuestType = ArenaQuestType.RankUp,
                DramaId = "rank_up_E",
                DisplayNameJP = "ランクE昇格試合（錆びついた英雄カイン）",
                DisplayNameEN = "Rank E Promotion Trial (Rusted Hero Cain)",
            ...
            var q_10_rank_up_D = new ArenaQuestDefinition
            {
                ...
                QuestType = ArenaQuestType.RankUp,
                DramaId = "rank_up_D",
                DisplayNameJP = "ランクD昇格試合（銅貨稼ぎの洗礼）",
                ...
                RequiredQuests = new List<string> { "07_upper_existence" },
                Priority = 900
            };
            ...
            var q_09_rank_up_C = new ArenaQuestDefinition
            {
                ...
                QuestType = ArenaQuestType.RankUp,
                DramaId = "rank_up_C",
                DisplayNameJP = "ランクC昇格試合（朱砂食い）",
                DisplayNameEN = "Rank C Promotion Trial (Cinnabar Eater)",
                Description = "堕ちた英雄たちを解放し、ランクCを獲得する",
                Phase = StoryPhase.Awakening,
                QuestGiver = "sukutsu_arena_master",
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "09_balgas_training" },
                Priority = 900
            };
            ...
            var q_11_rank_up_B = new ArenaQuestDefinition
            {
                ...
                QuestType = ArenaQuestType.RankUp,
                DramaId = "rank_up_B",
                DisplayNameJP = "ランクB昇格試合（虚無の処刑人ヌル）",
            ...
            var q_15_vs_balgas = new ArenaQuestDefinition
            {
                ...
                QuestType = ArenaQuestType.RankUp,
                DramaId = "vs_balgas",
                DisplayNameJP = "Rank S 昇格試合『竜断ちへの道』",
            ...
            var q_15_vs_balgas_spared = new ArenaQuestDefinition
            {
                ...
                DisplayNameEN = "Rank S: Spare Vargus",
                Description = "バルガスを見逃し、慈悲の道を選んだ",
                Phase = StoryPhase.Confrontation,
                QuestGiver = "sukutsu_arena_master",
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "12_rank_up_A", "15_vs_balgas" },
                Priority = 900
            };
            ...
            var q_15_vs_balgas_killed = new ArenaQuestDefinition
            {
                ...
                DisplayNameEN = "Rank S: Kill Vargus",
            ...
            var q_05_2_zek_steal_bottle_accept = new ArenaQuestDefinition
            {
                ...
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "05_1_lily_experiment", "05_2_zek_steal_bottle" },
                Priority = 700
            };
            ...
            var q_06_2_zek_steal_soulgem = new ArenaQuestDefinition
            {
                ...
                DisplayNameEN = "Fate of Cain's Soul",
            ...
            var q_06_2_zek_steal_soulgem_sell = new ArenaQuestDefinition
            {
                ...
                DisplayNameEN = "Cain's Soul: Sold",
                Description = "カインの魂をゼクに売った",
                Phase = StoryPhase.Rising,
                QuestGiver = "sukutsu_shady_merchant",
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "06_rank_up_E", "06_2_zek_steal_soulgem" },
                Priority = 850
            };
            ...
            var q_06_2_zek_steal_soulgem_return = new ArenaQuestDefinition
            {
                ...
                DisplayNameEN = "Cain's Soul: Returned",
            ...
            var q_13_makuma2 = new ArenaQuestDefinition
            {
                ...
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "12_makuma" },
                Priority = 850
            };
            _quests["13_makuma2"] = q_13_makuma2;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_13_makuma2);
            ...
            var q_18_last_battle = new ArenaQuestDefinition
            {
                ...
                QuestGiver = "sukutsu_shady_merchant",
                AutoTrigger = false,
                AdvancesPhase = StoryPhase.Postgame,
            ...
            if (!_npcQuests.ContainsKey("sukutsu_shady_merchant"))
                _npcQuests["sukutsu_shady_merchant"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_shady_merchant"].Add(q_18_last_battle);

            var q_pg_02a_resurrection_intro = new ArenaQuestDefinition
            {
                QuestId = "pg_02a_resurrection_intro",
                QuestType = ArenaQuestType.Postgame,
                DramaId = "resurrection_intro",
                DisplayNameJP = "蘇りの儀式・導入",
                DisplayNameEN = "The Resurrection Ritual - Preparation",
                Description = "バルガスとカインを蘇らせるための儀式について説明を受ける。",
                Phase = StoryPhase.Postgame,
                QuestGiver = "sukutsu_receptionist",
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "18_last_battle" },
                Priority = 590
            };
            _quests["pg_02a_resurrection_intro"] = q_pg_02a_resurrection_intro;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_pg_02a_resurrection_intro);

            var q_pg_02b_resurrection_execution = new ArenaQuestDefinition
            {
                QuestId = "pg_02b_resurrection_execution",
                QuestType = ArenaQuestType.Postgame,
                DramaId = "resurrection_execution",
                DisplayNameJP = "蘇りの儀式・実行",
                DisplayNameEN = "The Resurrection Ritual - Execution",
                Description = "素材を集めて蘇りの儀式を行う。",
                Phase = StoryPhase.Postgame,
                QuestGiver = "sukutsu_receptionist",
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "pg_02a_resurrection_intro" },
                Priority = 580
            };
            _quests["pg_02b_resurrection_execution"] = q_pg_02b_resurrection_execution;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_pg_02b_resurrection_execution);

            var q_pg_03_scroll_showcase = new ArenaQuestDefinition
            {
                QuestId = "pg_03_scroll_showcase",
                QuestType = ArenaQuestType.Postgame,
                DramaId = "p2_03_scroll_showcase",
                DisplayNameJP = "大部屋の巻物お披露目会",
                DisplayNameEN = "Scroll of Great Hall Showcase",
                Description = "リリィの研究成果「大部屋の巻物」のお披露目会が開催される。",
                Phase = StoryPhase.Postgame,
                QuestGiver = "sukutsu_receptionist",
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "pg_02b_resurrection_execution" },
                Priority = 570
            };
            _quests["pg_03_scroll_showcase"] = q_pg_03_scroll_showcase;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_pg_03_scroll_showcase);
